...
@section('content')
    <div id="content" class="bg-container">
        @include('partials.breadcrumb',['page_name' => "Create Product"])
        <div class="outer">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control chzn-select" required tabindex="2"
                                                        ...
                                                        @foreach($author_roles as $author_role)
                                                            <option value="{{$author_role->id}}">{{$author_role->role}}</option>
                                                        @endforeach()
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control chzn-select" required tabindex="2"
                                                        ...
                                                        @foreach($publisher_roles as $publisher_role)
                                                            <option value="{{$publisher_role->id}}">{{$publisher_role->role}}</option>
                                                        @endforeach()
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row m-t-20">
                                            <div class="col-lg-5">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" required class="form-control" id="selling_price"
                                                           name="selling_price">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 push-lg-2">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon">$</span>
                                                    <input type="text" required class="form-control" id="cost_price"
                                                           name="cost_price">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control chzn-select" required tabindex="2"
                                                        ...
                                                        @foreach($product_types as $product_type)
                                                            <option value="{{$product_type->id}}">{{$product_type->type}}</option>
                                                        @endforeach()
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control chzn-select" required tabindex="2"
                                                        ...
                                                        @foreach($cover_types as $cover_type)
                                                            <option value="{{$cover_type->id}}">{{$cover_type->type}}</option>
                                                        @endforeach()
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row m-t-35">
                                            ...
                                            <div class="col-lg-5 push-lg-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="num_pages"
                                                           name="num_pages">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-5">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control datepicker" id="release_date"
                                                           name="release_date">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row m-t-20">
                                            <div class="col-lg-5">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="pdf_link"
                                                           name="pdf_link">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 push-lg-2">
                                                ...
                                                <span class="input-group-addon"><i
                                                    ...
                                                    <input type="text" class="form-control" id="audio_file"
                                                           name="audio_file">
                                                </div>
                                            </div>
                                        </div>
